<nav class="fixed top-0 z-[100] w-full bg-white border-b border-gray-200">
...
<aside id="logo-sidebar"
  class="fixed top-0 left-0 z-[80] w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0"
  aria-label="Sidebar">
...
<div class="p-4 sm:ml-64">
  <div class="p-4 border-2 border-gray-200 border-dashed rounded-lgmt-14">
  ...
  <div class="relative p-4 w-full max-w-md max-h-full">
    <div class="relative bg-white rounded-lg shadow">
      ...
      <div class="p-4 md:p-5 text-center">
        ...
        <h3 class="mb-5 text-lg font-normal text-gray-500">Anda yakin untuk keluar?</h3>
        <a href="services/auth/logout.php" data-modal-hide="popup-modal"
